...
namespace ElectronicsStore.Data.Migrations
{
    ...
    [Migration("20211004102623_AddDescriptionToStoreItem")]
    partial class AddDescriptionToStoreItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectronicsStore.Models.StoreItem", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("StoreItem");
                });
            ...
            modelBuilder.Entity("ElectronicsStore.Models.OrderStoreItem", b =>
                {
                    b.HasBaseType("ElectronicsStore.Models.StoreItem");
                    ...
                    b.HasDiscriminator().HasValue("OrderStoreItem");
                });
            ...
            modelBuilder.Entity("ElectronicsStore.Models.OrderStoreItem", b =>
                {
                    b.HasOne("ElectronicsStore.Models.ShoppingUser", null)
                        .WithMany("OrderStoreItems")
                        .HasForeignKey("ShoppingUserId");
                });

            modelBuilder.Entity("ElectronicsStore.Models.ShoppingUser", b =>
                {
                    b.Navigation("OrderStoreItems");
                });
